...
int main(int argc, char **argv){
	...
	for(h=0; h<2;h++){
		for(f=0; f<45;f++){			
			snprintf(file, sizeof(file), "/home/alix/Documents/ALIX/ALIX/DisplayLab/images/happy/frame%d.png", f);
			PNGTest(&dev, file, SCREEN_WIDTH, SCREEN_HEIGHT);
			sleep(0.01);
		}
	}
	snprintf(file, sizeof(file), "/home/alix/Documents/ALIX/ALIX/DisplayLab/images/happy/frame0.png");
	PNGTest(&dev, file, SCREEN_WIDTH, SCREEN_HEIGHT);
	sleep(0.01);
}
